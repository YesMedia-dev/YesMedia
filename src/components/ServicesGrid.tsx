...
const services = [
  { title: "Overview", image: "/assets/services1.png", path: "/services/services_overview", size: 110 },
  { title: "Rehabilitation", image: "/assets/services2.png", path: "/services/rehabilitation", size: 80 },
  { title: "Skilled Nursing", image: "/assets/services3.png", path: "/services/nursing", size: 130 },
  { title: "Social Services", image: "/assets/services4.png", path: "/services/social", size: 140 },
  { title: "Activities", image: "/assets/services5.png", path: "/services/activities", size: 130 },
];
      ...
      <div className="py-20 max-w-6xl mx-auto px-8 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 place-items-center">
          {services.map(({ title, image, path, size }, index) => (
            <Link href={path} key={title} className={`text-center group w-full ${index === 3 ? 'flex justify-end ml-40' : index === 4 ? 'flex justify-end ml-30' : ''}`}>
